...
const SingleUserPage = async ({
  ...
  const user:
    | (User & {
        _count: { shortLinks: number; domains: number };
      })
    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              />
              <div className="">
                <h1 className="text-xl font-semibold">{user.limit}</h1>
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">Shortlinks</span>
              </div>
            </div>
            {/* CARD */}
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              />
              <div className="">
                <h1 className="text-xl font-semibold">{user._count.domains}</h1>
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">Active Until</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* <div className="mt-4 bg-white rounded-md p-4 h-[800px]">
          ...
          <BigCalendarContainer type="userId" id={user.id} />
        </div> */}
      </div>
      {/* RIGHT */}
